    ...
    return(
        <div className='about'>
            ...
            <p className='about__text'>
                Мы команда специалистов по ремонту и обслуживанию <span className='about__text about__text_color_yellow'>бытовой техники</span > и <span className='about__text about__text_color_yellow'>сантехники. </span>
